...
- Day 7 收到第一則訊息時，依訊息豐富度選擇路徑（見 6.4），**保證衝突一定在 Day 7 發生**
...
各組別引導深化語句（寫死於 `D7_FOLLOWUP_MESSAGES`）：

| 組別 | 引導深化語句 |
|------|-------------|
| A / E（協作型）| 欸，你來了。最近有什麼事嗎？跟我說說？ |
| B / F（攻擊型）| 說點正事，最近怎樣。 |
| C / G（遷就型）| 你來找我了 😊 最近有什麼事嗎？跟我說說嘛 |
| D / H（迴避型）| 嗯。最近怎樣。 |
